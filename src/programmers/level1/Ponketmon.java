...
public class Ponketmon {
    public int solution(int[] nums) {
        ...
        return Math.min(items.size(), pickSize);
    }
}
/*
    개인 해설
    처음 문제를 읽었을 때는 굉장히 복잡하게 생각이 들어서 금방 풀 수 없었던 문제입니다.
    문제의 핵심 포인트는 중복되지 않는 수의 카운트와 선택할 폰켓몬의 수 중 작은 수를 리턴하면 되는 것이었습니다.
    Set을 이용하여 중복을 제거하면 된다고 생각했고, Set 중 가장 속도가 빠른 HashSet을 사용하였습니다.
