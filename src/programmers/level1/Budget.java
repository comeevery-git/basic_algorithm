...
/*
    개인 해설
    각 부서에서 금액을 요청하면 금액과 똑같이 떨어지는 금액만 예산에서 할당할 수 있습니다.
    예산에서 어떻게 할당할까 고민하다가 빼주는 방식을 선택했고, 정확히 나누어주는 방법을 고민하다 정렬하여 해결하였습니다.
    정확한 금액을 할당해주지 못하면 음수가 되어 for 문을 빠져나가게 됩니다 :)
